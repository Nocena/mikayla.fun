...
float rayStrength(vec2 raySource, vec2 rayRefDirection, vec2 coord, float seedA, float seedB, float speed) {
  ...
  float pulse = pulsating > 0.5 ? (0.8 + 0.2 * sin(iTime * speed * 2.5)) : 1.0;
...
void main() {
  ...
  gl_FragColor = vec4(fragColor.rgb, fragColor.a * 0.4);
}`;
      ...
      const loop = (t) => {
        ...
        if (followMouse) {
          smoothMouse.x = smoothMouse.x * 0.94 + mouse.x * 0.06;
          smoothMouse.y = smoothMouse.y * 0.94 + mouse.y * 0.06;
      ...
      console.warn("WebGL LightRays failed to initialize:", err);
    }
