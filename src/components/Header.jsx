        ...
        <div className="w-full bg-[#080808]/80 backdrop-blur-2xl border-b border-white/[0.08] shadow-[0_4px_30px_rgba(0,0,0,0.5)] transition-colors">
          <div className="max-w-[90rem] mx-auto flex items-center justify-between px-3.5 sm:px-10 h-14">
            ...
            <nav className="hidden md:flex items-center gap-7 text-xs font-mono tracking-[0.06em] uppercase">
              ...
              <Link
                to="/vault"
                className="text-white/80 hover:text-[#d4fc50] font-medium transition-colors py-1 flex items-center gap-1.5"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-[#30d158] shadow-[0_0_6px_#30d158]" />
                <span>VIP Vault</span>
                <span className="text-[9px] px-1.5 py-0.5 rounded bg-white/10 text-white/80 font-mono border border-white/10">STAKE</span>
              </Link>
              <a
                href="#upcoming-drops"
        ...
        {openNavigation && (
          <div className="md:hidden absolute top-full inset-x-0 h-[calc(100dvh-100%)] bg-[#080808]/98 backdrop-blur-3xl border-b border-white/10 p-5 pb-8 flex flex-col justify-between animate-fadeIn z-50 overflow-y-auto">
            <div className="space-y-2 pt-2">
              {[
                { href: "/vault", label: "🔒 // CREATOR VAULTS (STAKE)", sub: "3-Day Timelock · Verified Partner Creator Archives" },
